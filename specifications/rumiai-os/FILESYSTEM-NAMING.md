...
This specification applies to filesystem names controlled or automatically generated by `m` or RumiAI. External/user-supplied pathnames remain opaque data and are not rewritten merely to satisfy internal naming style.

## Controlled pathname components

Unless a more specific current contract defines an exception, a pathname component controlled by `m` or RumiAI uses only:
