...
Remote/network artifact transport, cross-user artifact sharing/trust, cache eviction/garbage collection, parallel scheduling and remote execution remain unimplemented.
...
CURRENT-75   corrupt selected shared artifact state is a conservative miss refreshed through another immutable candidate; eviction/garbage collection and remote/cross-user artifact transport remain outside the current baseline
```
