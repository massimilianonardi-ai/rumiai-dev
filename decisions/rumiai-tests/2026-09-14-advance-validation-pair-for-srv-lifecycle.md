...
La nuova configurazione di validation è:
...
La revisione corrente della suite che contiene sia il permanent test finale sia questa configurazione è:

```text
rumiai-tests@a4d1588f8966689e20465e6943e446e78a5fb3f0
```

La revisione prodotto è:

```text
rumiai-os@eacf95a81b38043882ebcea88b951c8ba22c601d
```

La selection resta l'intero gruppo `rumiai-os`.
...
non costituisce evidence per la nuova coppia.

## 6. Physical validation richiesta

La nuova coppia deve essere esercitata sui reference host applicabili, almeno:
...
Finché tali run non vengono completati e registrati, lo stato resta **physical validation pending**.

## 7. Invarianti

```text
VALSRV-01  la coppia target è rumiai-os@eacf95a81b38043882ebcea88b951c8ba22c601d con rumiai-tests@a4d1588f8966689e20465e6943e446e78a5fb3f0
VALSRV-02  la selection è rumiai-os
VALSRV-03  evidence precedente non viene reinterpretata
VALSRV-04  la nuova coppia richiede validation sui reference host applicabili
