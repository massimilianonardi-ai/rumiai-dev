...
## 12. Limite sul nome della cartella

La data corrente/di inizio disponibile è `2026-08-26`. Il titolo esatto mostrato dall'interfaccia ChatGPT non è esposto agli strumenti utilizzati per l'archiviazione. Per non dichiarare come esatto un dato non verificabile, è stato usato il titolo descrittivo `Importazione chat RumiAI`. Se in futuro viene fornito il titolo UI esatto, la cartella potrà essere rinominata.
